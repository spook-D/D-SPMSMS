...
class Spammer:
    ...
    def main(self):
        print color.BOLD + color.WARNING + '+-+-+-+-+-+-+-+' + color.ENDC + color.BOLD + ' SMS Spammer v1.1\n' + color.BOLD + color.WARNING + '|D|-|S|p|o|o|k|' + color.ENDC + color.BOLD + '\tAuthor: D-Spook\n' + color.BOLD + color.WARNING + '+-+-+-+-+-+-+-+' + color.ENDC + color.BOLD + ' ' + color.UNDERLINE + 'https://github.com/spook-d\n\t\t' + color.ENDC
